...
-- Records of approval
-- ----------------------------
INSERT INTO `approval` VALUES (2, 2, 1, 27, '2021-04-24 21:13:41', 2);
...
CREATE TABLE `classes`  (
  ...
  `classes_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '班级名称',
  `update_date` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `introduction` varchar(600) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '班级简介',
  `people_num` int NULL DEFAULT NULL COMMENT '班级人数',
  `creator_id` int NOT NULL COMMENT '创建者id',
  `joinWay` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT 'all' COMMENT '班级加入方式  no:不允许加入 all:允许任何人加入  apply:需要管理员同意',
  PRIMARY KEY (`classes_id`) USING BTREE,
  INDEX `FK`(`creator_id` ASC) USING BTREE,
...
CREATE TABLE `exam`  (
  ...
  `exam_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '试卷名称',
  `creator_id` int UNSIGNED NOT NULL COMMENT '创建者id',
  `time` int UNSIGNED NULL DEFAULT NULL COMMENT '答题时间(分钟)',
  `create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_date` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `subject_id` int UNSIGNED NULL DEFAULT NULL COMMENT '科目类型id',
  `subject_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '科目类型名称',
  ...
  `switch_page` int NULL DEFAULT -1 COMMENT '允许页面切换次数  -1: 允许多次切换  5: 默认',
...
CREATE TABLE `subjects`  (
  ...
  `subjects_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '科目名称',
  `create_id` int NULL DEFAULT NULL COMMENT '创建者id',
  `create_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建者名称',
  `create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_date` datetime NULL DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE `topic`  (
  ...
  `creator_id` int NOT NULL COMMENT '创建者id',
  `subject_id` int NULL DEFAULT NULL COMMENT '科目类型id',
  `subject_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '科目类型名称',
  `question` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '题目',
  `choice` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项',
  `photo` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片',
  `topic_type` int NOT NULL COMMENT '题目类型  0:单选题 1:多选题 2:判断题 3:填空题 4:简答题',
  `correct_answer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '正确答案',
  `score` float NULL DEFAULT 0 COMMENT '分数',
  `difficulty` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '中等' COMMENT '难度  简单,中等(默认),困难',
  `analysis` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '答案分析',
  `required` int NULL DEFAULT 0 COMMENT '非必填:0   必填:1',
  `create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_date` datetime NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`topic_id`) USING BTREE,
  INDEX `suoyin2`(`creator_id` ASC) USING BTREE,
...
CREATE TABLE `user`  (
  ...
  `sex` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '男' COMMENT '性别',
  ...
  `role` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT 'student' COMMENT '身份 student:学生  teacher:是教师身份',
  `work` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '工作职位',
  `update_date` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `create_date` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `photo` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '头像图片',
  `photo_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图片名称',
  PRIMARY KEY (`user_id`) USING BTREE,
  UNIQUE INDEX `souyin1`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', '男', '13000000000', '762489117@qq.com', 'student', '教师', '2024-03-18 08:11:33', '2020-11-16 15:51:00', '26651ce8c393400898d71a64da22d92a.jpg', 'fbab4835a816e500f49fda12633f9873.jpg');
...
INSERT INTO `user` VALUES (15, 'cangling', NULL, '', '123456123@qq.com', 'student', NULL, '2024-03-18 08:15:39', '2024-03-18 08:15:17', NULL, NULL);
...
CREATE TABLE `user_classes`  (
  ...
  `classes_id` int NOT NULL COMMENT '班级id',
  `position` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '身份   creator:创建者  student:学生  admin:管理员',
  `enter_date` datetime NULL DEFAULT NULL COMMENT '加入时间',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `user_classes` VALUES (66, 1, 26, 'student', '2024-03-18 08:10:26');
...
CREATE TABLE `user_grade`  (
  ...
  `answer_date` datetime NULL DEFAULT NULL COMMENT '答题日期',
  ...
  `mark_date` datetime NULL DEFAULT NULL COMMENT '批改日期',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `user_grade` VALUES (18, 2, 26, 19, 40, 25, '2021-04-02 10:32:48', 74, 1, 1, '2024-03-18 08:13:01');
...
CREATE TABLE `user_password`  (
  `user_id` int NOT NULL COMMENT '用户id',
  `password` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '用户登录密码',
  PRIMARY KEY (`user_id`) USING BTREE
...
INSERT INTO `user_password` VALUES (15, '123456');
...
CREATE TABLE `user_topic`  (
  ...
  `topic_status` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '0:待批改 1:批改完成',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `user_topic` VALUES (295, 2, 26, 19, 57, '选项1', 10, '1');
INSERT INTO `user_topic` VALUES (296, 2, 26, 19, 58, '选项2\n选项3', 10, '1');
INSERT INTO `user_topic` VALUES (297, 2, 26, 19, 59, 'false', 0, '1');
INSERT INTO `user_topic` VALUES (298, 2, 26, 19, 60, 'www\n222', 10, '1');
INSERT INTO `user_topic` VALUES (299, 2, 26, 19, 61, 'asd123aif', 10, '1');
